...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    reelsTitle: "Instagram Reels and Native Video Ads",
    reelsDescription: "Click the play button to watch the videos",
    ...
    // Social Media Portfolio translations
    bioSocialMediaPortfolio: "Social Media Portfolio",
    bioSocialMediaPortfolioDesc: "Explore Carolina's creative work in video editing, copywriting & storytelling that drives real results",
    bioViewPortfolio: "View Portfolio",
    // Real Estate Opportunities Modal translations
    realEstateModalTitle: "Real Estate Investment Opportunities",
    realEstateModalSubtitle: "Select your preferred investment destination to explore exclusive opportunities",
    baliTitle: "Bali",
    baliDescription: "Emerging market with high growth potential and attractive yields.",
    dubaiTitle: "Dubai",
    dubaiDescription: "Luxury real estate hub with tax advantages and world-class infrastructure.",
    brazilTitle: "Brazil",
    brazilDescription: "Diverse market opportunities with strong fundamentals and growth prospects.",
    // WhatsApp message translations
    whatsappBaliMessage: "Hey Carolina, I want to know about opportunities on Real Estate in Bali",
    whatsappDubaiMessage: "Hey Carolina, I want to know about opportunities on Real Estate in Dubai",
    whatsappBrazilMessage: "Hey Carolina, I want to know about opportunities on Real Estate in Brazil",
    // Travel & Wellness Modal translations
    travelWellnessModalTitle: "Travel & Wellness Consulting",
    travelWellnessModalSubtitle: "Plan your dream trips and take care of your wellness with specialized consulting.",
    travelWellnessModalDescription: "Tell us about your travel and wellness goals, and we'll create a personalized plan for you.",
  ...
  pt: {
    ...
    reelsTitle: "Reels do Instagram e Anúncios de Vídeo Nativo",
    reelsDescription: "Clique no botão de reprodução para assistir aos vídeos",
    ...
    // Social Media Portfolio translations
    bioSocialMediaPortfolio: "Portfólio de Social Media",
    bioSocialMediaPortfolioDesc: "Explore o trabalho criativo de Carolina em edição de vídeo, copywriting e storytelling que gera resultados reais",
    bioViewPortfolio: "Ver Portfólio",
    // Real Estate Opportunities Modal translations
    realEstateModalTitle: "Oportunidades de Investimento Imobiliário",
    realEstateModalSubtitle: "Selecione seu destino de investimento preferido para explorar oportunidades exclusivas",
    baliTitle: "Bali",
    baliDescription: "Mercado emergente com alto potencial de crescimento e rendimentos atrativos.",
    dubaiTitle: "Dubai",
    dubaiDescription: "Hub imobiliário de luxo com vantagens fiscais e infraestrutura de classe mundial.",
    brazilTitle: "Brasil",
    brazilDescription: "Diversas oportunidades de mercado com fundamentos sólidos e perspectivas de crescimento.",
    // WhatsApp message translations
    whatsappBaliMessage: "Oi Carolina, quero saber sobre oportunidades de investimento imobiliário em Bali",
    whatsappDubaiMessage: "Oi Carolina, quero saber sobre oportunidades de investimento imobiliário em Dubai",
    whatsappBrazilMessage: "Oi Carolina, quero saber sobre oportunidades de investimento imobiliário no Brasil",
    // Travel & Wellness Modal translations
    travelWellnessModalTitle: "Consultoria de Viagens e Bem Estar",
    travelWellnessModalSubtitle: "Planeje suas viagens dos sonhos e cuide do seu bem estar com consultoria especializada.",
    travelWellnessModalDescription: "Conte-nos sobre seus objetivos de viagem e bem estar, e criaremos um plano personalizado para você.",
  ...
  es: {
    ...
    reelsTitle: "Reels de Instagram y Anuncios de Video Nativo",
    reelsDescription: "Haz clic en el botón de reproducción para ver los videos",
    ...
    // Social Media Portfolio translations
    bioSocialMediaPortfolio: "Portafolio de Social Media",
    bioSocialMediaPortfolioDesc: "Explora el trabajo creativo de Carolina en edición de video, copywriting y storytelling que genera resultados reales",
    bioViewPortfolio: "Ver Portafolio",
    // Real Estate Opportunities Modal translations
    realEstateModalTitle: "Oportunidades de Inversión Inmobiliaria",
    realEstateModalSubtitle: "Selecciona tu destino de inversión preferido para explorar oportunidades exclusivas",
    baliTitle: "Bali",
    baliDescription: "Mercado emergente con alto potencial de crecimiento y rendimientos atractivos.",
    dubaiTitle: "Dubai",
    dubaiDescription: "Centro inmobiliario de lujo con ventajas fiscales e infraestructura de clase mundial.",
    brazilTitle: "Brasil",
    brazilDescription: "Diversas oportunidades de mercado con fundamentos sólidos y perspectivas de crecimiento.",
    // WhatsApp message translations
    whatsappBaliMessage: "Hola Carolina, quiero saber sobre oportunidades de inversión inmobiliaria en Bali",
    whatsappDubaiMessage: "Hola Carolina, quiero saber sobre oportunidades de inversión inmobiliaria en Dubai",
    whatsappBrazilMessage: "Hola Carolina, quiero saber sobre oportunidades de inversión inmobiliaria en Brasil",
    // Travel & Wellness Modal translations
    travelWellnessModalTitle: "Consultoría de Viajes y Bienestar",
    travelWellnessModalSubtitle: "Planifica tus viajes de ensueño y cuida tu bienestar con consultoría especializada.",
    travelWellnessModalDescription: "Cuéntanos sobre tus objetivos de viaje y bienestar, y crearemos un plan personalizado para ti.",
    startConsultation: "Iniciar Consultoría",
  },
  ar: {
    ...
    reelsTitle: "ريلز إنستغرام وإعلانات الفيديو الأصلية",
    reelsDescription: "انقر على زر التشغيل لمشاهدة الفيديوهات",
    ...
    // Social Media Portfolio translations
    bioSocialMediaPortfolio: "محفظة وسائل التواصل الاجتماعي",
    bioSocialMediaPortfolioDesc: "استكشف العمل الإبداعي لكارولينا في تحرير الفيديو والكتابة الإعلانية وسرد القصص الذي يحقق نتائج حقيقية",
    bioViewPortfolio: "عرض المحفظة",
    // Real Estate Opportunities Modal translations
    realEstateModalTitle: "فرص الاستثمار العقاري",
    realEstateModalSubtitle: "اختر وجهة الاستثمار المفضلة لديك لاستكشاف الفرص الحصرية",
    baliTitle: "بالي",
    baliDescription: "سوق ناشئ بإمكانات نمو عالية وعوائد جذابة.",
    dubaiTitle: "دبي",
    dubaiDescription: "مركز عقاري فاخر مع مزايا ضريبية وبنية تحتية عالمية المستوى.",
    brazilTitle: "البرازيل",
    brazilDescription: "فرص سوق متنوعة مع أساسيات قوية وآفاق نمو.",
    // WhatsApp message translations
    whatsappBaliMessage: "مرحباً كارولينا، أريد معرفة المزيد عن فرص الاستثمار العقاري في بالي",
    whatsappDubaiMessage: "مرحباً كارولينا، أريد معرفة المزيد عن فرص الاستثمار العقاري في دبي",
    whatsappBrazilMessage: "مرحباً كارولينا، أريد معرفة المزيد عن فرص الاستثمار العقاري في البرازيل",
    // Travel & Wellness Modal translations
    travelWellnessModalTitle: "استشارات السفر والعافية",
    travelWellnessModalSubtitle: "خطط لرحلات أحلامك واعتني بعافيتك مع استشارات متخصصة.",
    travelWellnessModalDescription: "أخبرنا عن أهدافك في السفر والعافية، وسننشئ خطة مخصصة لك.",
